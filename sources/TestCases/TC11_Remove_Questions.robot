...
Resource    ../Resources/RS_Remove_Questions.robot
Resource    ../Resources/RS_Login.robot

*** Test Cases ***
TC11_Remove_Question
    Officer Login
    Start Video Recording   alias=None  name=TC11_Remove_Question  fps=None    size_percentage=1   embed=True  embed_width=100px   monitor=1
    Open Excel Document     TestData//TC11_Remove_Questions.xlsx     doc_id=TestData
    ...
    END
    Save Excel Document       Result/WriteExcel/TC11_Remove_Questions_result.xlsx
