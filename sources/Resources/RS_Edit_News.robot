...
*** Variables ***
${EditNew_Url}            http://localhost:8086/TeeDin/editnews/106
...
${topics_alert_1}        (//*[@data-bv-validator='notEmpty'])[1]
${topics_alert_2}        (//*[@data-bv-validator='stringLength'])[1]
${detail_alert_1}        (//*[@data-bv-validator='notEmpty'])[2]
${detail_alert_2}        (//*[@data-bv-validator='stringLength'])[2]
${image1_alert_1}        (//*[@data-bv-validator='notEmpty'])[3]
${image2_alert_1}        (//*[@data-bv-validator='notEmpty'])[4]
${image3_alert_1}        (//*[@data-bv-validator='notEmpty'])[5]